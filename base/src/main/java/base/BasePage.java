...
public class BasePage {
    ...
    @BeforeMethod
    public void driverSetup(@Optional("true") String driverConfigEnabled, @Optional("chrome") String browser, @Optional("https://classic.crmpro.com/index.html") String url) {
